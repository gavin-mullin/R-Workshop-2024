---
title: "Assignment 1 (Chapter 3)"
---

This is an [R Markdown](http://rmarkdown.rstudio.com) Notebook. When you execute code within the notebook (can do by pressing the 'play' button in the top right of code chunks), the results appear beneath the code. 

Try executing this chunk by clicking the *Run/Play* button within the chunk or by placing your cursor inside it and pressing *Ctrl+Shift+Enter*. 
